...
class Calculadora:
    ...
    def __init__(self, ventana):
        ...
        self.ventana.title("Calaculadora POO")
        self.operacion=""
        ...
        #----------------Definicion Lista de botones-----
        
        botones=[boton7, boton8, boton9, botondiv, boton4, boton5, boton6, botonx, boton1, boton2, boton3, botonrest, botoncero, botoncoma, botonigual, botonmas]
    ...
    def colocar_Boton(self, valor, mostrar=True, ancho=9, alto=1):
        ...
        return Button(self.ventana, text=valor, width=ancho, height=alto, font=("Helvetica", 9), command=lambda:self.pulsaciones_teclas(valor, mostrar))
